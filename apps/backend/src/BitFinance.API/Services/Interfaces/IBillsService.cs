...
public interface IBillsService
{
    ...
    Task<List<Bill>> GetUpcomingBills(Guid organizationId, DateTime? from = null, DateTime? to = null);
    ...
    Task<(decimal TotalAmount, int Count)> GetUpcomingBillsSummaryAsync(Guid organizationId, DateTime? from = null, DateTime? to = null);
}
