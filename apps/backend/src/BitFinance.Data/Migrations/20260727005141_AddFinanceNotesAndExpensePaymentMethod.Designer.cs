...
namespace BitFinance.Data.Migrations
{
    ...
    [Migration("20260727005141_AddFinanceNotesAndExpensePaymentMethod")]
    partial class AddFinanceNotesAndExpensePaymentMethod
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BitFinance.Business.Entities.Budget", b =>
                {
                    ...
                    b.HasIndex("OrganizationId")
                        .IsUnique()
                        .HasDatabaseName("ix_budgets_organization_id");

                    b.ToTable("budgets", null, t =>
                        {
                            t.HasCheckConstraint("ck_budgets_amount_non_negative", "amount >= 0");
                        });
                });
            ...
            modelBuilder.Entity("BitFinance.Business.Entities.Budget", b =>
                {
                    b.HasOne("BitFinance.Business.Entities.Organization", "Organization")
                        .WithOne("Budget")
                        .HasForeignKey("BitFinance.Business.Entities.Budget", "OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_budgets_organizations_organization_id");
