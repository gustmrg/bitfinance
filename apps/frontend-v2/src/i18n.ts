...
const resources = {
  "en-US": { translation: {
    ...
    common: { save: "Save changes", cancel: "Cancel", close: "Close", add: "Add", edit: "Edit", delete: "Delete", search: "Search", all: "All", today: "Today", viewAll: "View all", loading: "Loading", noResults: "No results", clearFilters: "Clear filters", signIn: "Sign in", signUp: "Create account", continue: "Continue", invite: "Invite member", copy: "Copy invite link" },
    home: { eyebrow: "A clearer view of your money", title: "Make room for the life you’re planning.", body: "BitFinance brings bills, spending, and shared decisions into one calm workspace — so your next move is always visible.", cta: "Open the live desk", secondary: "See how it works", signal: "Built for real-life money moments" },
    auth: { signInTitle: "Welcome back", signInBody: "Your money desk is ready for today’s decisions.", signUpTitle: "Start with a clearer picture", signUpBody: "Create a workspace for the people and plans that matter.", email: "Email address", password: "Password", firstName: "First name", lastName: "Last name", noAccount: "New to BitFinance?", haveAccount: "Already have an account?" },
    dashboard: { eyebrow: "Selected period", title: "Good morning", body: "Here’s the shape of your money in the selected period.", budget: "Monthly budget", spent: "Spent so far", remaining: "Available", upcoming: "Upcoming", flow: "Cash-flow map", flowBody: "Your selected period, plotted as decisions instead of noise.", upcomingTitle: "Coming up", recentTitle: "Recent spending", categories: "Where it goes", onTrack: "You’re on track", setBudget: "Set a budget" },
    ...
    account: { eyebrow: "Your preferences", title: "Account", body: "Make the desk feel like yours.", profile: "Profile", appearance: "Appearance", language: "Language", theme: "Theme", signOut: "Sign out", reset: "Session preferences" },
  } },
  "pt-BR": { translation: {
    nav: { overview: "Visão geral", bills: "Contas", expenses: "Despesas", organization: "Organização", members: "Membros", account: "Conta" },
    common: { save: "Salvar alterações", cancel: "Cancelar", close: "Fechar", add: "Adicionar", edit: "Editar", delete: "Excluir", search: "Buscar", all: "Todos", today: "Hoje", viewAll: "Ver tudo", loading: "Carregando", noResults: "Sem resultados", clearFilters: "Limpar filtros", signIn: "Entrar", signUp: "Criar conta", continue: "Continuar", invite: "Convidar membro", copy: "Copiar convite" },
    ...
    auth: { signInTitle: "Bem-vinda de volta", signInBody: "Sua mesa financeira está pronta para as decisões de hoje.", signUpTitle: "Comece com uma visão mais clara", signUpBody: "Crie um espaço para as pessoas e planos que importam.", email: "E-mail", password: "Senha", firstName: "Nome", lastName: "Sobrenome", noAccount: "Ainda não usa o BitFinance?", haveAccount: "Já possui uma conta?" },
    dashboard: { eyebrow: "Período selecionado", title: "Bom dia", body: "Este é o desenho do seu dinheiro no período selecionado.", budget: "Orçamento mensal", spent: "Gasto até agora", remaining: "Disponível", upcoming: "A seguir", flow: "Mapa do fluxo", flowBody: "Seu período selecionado, plotado como decisões em vez de ruído.", upcomingTitle: "A seguir", recentTitle: "Gastos recentes", categories: "Para onde vai", onTrack: "Você está no caminho", setBudget: "Definir orçamento" },
