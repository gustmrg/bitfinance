...
public interface IBitFinanceApiClient
{
    ...
    Task<UploadDocumentResponse> UploadBillDocumentAsync(Guid billId, string filePath, string fileCategory, Guid? organizationId = null, string? contentType = null, CancellationToken cancellationToken = default);
