...
public interface IBitFinanceApiClient
{
    ...
    Task<PagedResponse<BillResponse>> ListBillsAsync(Guid? organizationId = null, int page = 1, int pageSize = 20, DateTimeOffset? from = null, DateTimeOffset? to = null, string? status = null, string? description = null, CancellationToken cancellationToken = default);
